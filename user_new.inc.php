...
else
{
	...
	$value .= '<option value=\''.GC_KATEG_M.'\''.(($zaznam["poh"]==GC_KATEG_M) ? ' SELECTED' : '').'>'.GC_KATEG_M.'</option>';
	$value .= '<option value=\''.GC_KATEG_W.'\''.(($zaznam["poh"]==GC_KATEG_W) ? ' SELECTED' : '').'>'.GC_KATEG_W.'</option>';
	$value .= '</select>';
