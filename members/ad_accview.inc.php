...
$data_tbl->set_header_col_with_help($col++,'news',ALIGN_CENTER,"Právo psát novinky");
$data_tbl->set_header_col_with_help($col++,'reg',ALIGN_CENTER,"Je-li pøihlšovatelem");
$data_tbl->set_header_col_with_help($col++,'mng',ALIGN_CENTER,"Je-li trenérem (pøípadnì malým trenérem)");
$data_tbl->set_header_col_with_help($col++,'fin',ALIGN_CENTER,"Je-li finanèníkem");
