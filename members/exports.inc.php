...
//protected
	...
	public function generate($with_born_dates = false)
	{
		...
		foreach($this->data as $zaznam)
		{
			...
			{	// datum narozenн (59-64) ve tvaru rrmmdd
...
class CSV_Export
{
	...
	{
		$text = '';
		$text .= 'pшнjmeni;jmйno;datum narozenн;reg;email;adresa;mesto;psc;tel.domщ;tel.prбce; tel.mobilnн;si.иip;licence OB;licence MTBO;licence LOB;nбrodnost;';
