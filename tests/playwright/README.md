...
- `workflows/member-lifecycle-flow.spec.js` covers the complete create-to-delete lifecycle for test member `4444`, including role-specific edits, assignment, finance, disable/enable, and account self-service.
